...
import { createReadableStreamFromReadable, redirect, createCookieSessionStorage, json, unstable_parseMultipartFormData, unstable_createMemoryUploadHandler } from "@remix-run/node";
import { RemixServer, useFormAction, useNavigation, useRouteError, useParams, isRouteErrorResponse, useSearchParams, useSubmit, Form, useRouteLoaderData, useRevalidator, useLoaderData, useMatches, Link, Outlet, useFetchers, useFetcher, Meta, Links, ScrollRestoration, Scripts, useLocation, useActionData, NavLink } from "@remix-run/react";
...
if (ENV.MODE === "production" && ENV.SENTRY_DSN) {
  import("./monitoring.server-0We1Jbrs.js").then(({ init: init2 }) => init2());
}
...
const iconsHref = "/assets/sprite-ZFGcH4af.svg";
const sizeClassName = {
  font: "w-[1em] h-[1em]",
  xs: "w-3 h-3",
  sm: "w-4 h-4",
...
const StatusButton = React.forwardRef(({ message, status, className, children, spinDelay, ...props }, ref) => {
  ...
  const companion = {
    pending: delayedPending ? /* @__PURE__ */ jsx("div", { className: "inline-flex h-6 w-6 items-center justify-center", children: /* @__PURE__ */ jsx(Icon, { name: "update", className: "animate-spin" }) }) : null,
    success: /* @__PURE__ */ jsx("div", { className: "inline-flex h-6 w-6 items-center justify-center", children: /* @__PURE__ */ jsx(Icon, { name: "check" }) }),
    error: /* @__PURE__ */ jsx("div", { className: "inline-flex h-6 w-6 items-center justify-center rounded-full bg-destructive", children: /* @__PURE__ */ jsx(Icon, { name: "cross-1", className: "text-destructive-foreground" }) }),
    idle: null
  }[status];
  return /* @__PURE__ */ jsxs(
    Button,
...
const tailwindStyleSheetUrl = "/assets/tailwind-S9uO6XH0.css";
...
const shouldMock = (_a = process.env.GITHUB_CLIENT_ID) == null ? void 0 : _a.startsWith("MOCK_");
...
function App() {
  ...
  useToast(data.toast);
  return /* @__PURE__ */ jsxs(Document, { nonce, theme, env: data.ENV, children: [
...
const UsernameSchema = z.string({ required_error: "Username is required" }).min(3, { message: "Username is too short" }).max(20, { message: "Username is too long" }).regex(/^[a-zA-Z0-9_]+$/, {
...
async function loader$r({ request, params }) {
  ...
  verifySession.set(prefilledProfileKey, {
    ...
    username: (_a2 = profile.username) == null ? void 0 : _a2.replace(/[^a-zA-Z0-9_]/g, "_").toLowerCase()
  });
...
const docker = "/assets/docker-imLqQTMk.svg";
...
const fakerJS = "/assets/faker--peHKZsd.svg";
const fly = "/assets/fly-jnKH59uU.svg";
...
const playwright = "/assets/playwright-9A7tyxXe.svg";
const prettier = "/assets/prettier-2yFZZFeA.svg";
const prisma = "/assets/prisma-CGiM-zK6.svg";
...
const reactEmail = "/assets/react-email-yj_pOApD.svg";
...
const resend = "/assets/resend-KmWqjv8c.svg";
...
const sqlite = "/assets/sqlite-u_NHLZml.svg";
...
const testingLibrary = "/assets/testing-library-5T2aVnz2.png";
...
const zod = "/assets/zod-E2LRXKhl.svg";
const logos = [
  {
    src: remix,
    alt: "Remix",
...
const serverManifest = { "entry": { "module": "/assets/entry.client-jCztRN5H.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/components-_HPsJqfq.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-utkkIrLF.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/components-_HPsJqfq.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/label-Je57Ihep.js", "/assets/status-button-90R1EB0H.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/honeypot-2dXBK_pE.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/search-bar-hmvYgNX5.js", "/assets/user-8GWnie8l.js", "/assets/performance-Q0p3jXRI.js", "/assets/parse-k_gbqDJY.js"], "css": [] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-ScVKCbBA.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/icon-A96BYhEN.js", "/assets/components-_HPsJqfq.js"], "css": [] }, "routes/_auth+/auth.$provider": { "id": "routes/_auth+/auth.$provider", "parentId": "root", "path": "auth/:provider", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/auth._provider-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/_auth+/auth.$provider.callback": { "id": "routes/_auth+/auth.$provider.callback", "parentId": "routes/_auth+/auth.$provider", "path": "callback", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/auth._provider.callback-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/_auth+/forgot-password": { "id": "routes/_auth+/forgot-password", "parentId": "root", "path": "forgot-password", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/forgot-password-GJUss3wI.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/honeypot-2dXBK_pE.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/_auth+/login": { "id": "routes/_auth+/login", "parentId": "root", "path": "login", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/login-nYqhQoUF.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/status-button-90R1EB0H.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/honeypot-2dXBK_pE.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/forms-N1UyfrLg.js", "/assets/spacer-HzAknbkR.js", "/assets/connections-eLlz8h2A.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/_auth+/logout": { "id": "routes/_auth+/logout", "parentId": "root", "path": "logout", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/logout-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/_auth+/onboarding": { "id": "routes/_auth+/onboarding", "parentId": "root", "path": "onboarding", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/onboarding-gVVJNSlx.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/honeypot-2dXBK_pE.js", "/assets/forms-N1UyfrLg.js", "/assets/spacer-HzAknbkR.js", "/assets/status-button-90R1EB0H.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/_auth+/onboarding_.$provider": { "id": "routes/_auth+/onboarding_.$provider", "parentId": "root", "path": "onboarding/:provider", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/onboarding_._provider-KctuE5xm.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/forms-N1UyfrLg.js", "/assets/spacer-HzAknbkR.js", "/assets/status-button-90R1EB0H.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/_auth+/reset-password": { "id": "routes/_auth+/reset-password", "parentId": "root", "path": "reset-password", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/reset-password-QyNYHYhC.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/_auth+/signup": { "id": "routes/_auth+/signup", "parentId": "root", "path": "signup", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/signup-HN6jnK5W.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/status-button-90R1EB0H.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/honeypot-2dXBK_pE.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/forms-N1UyfrLg.js", "/assets/connections-eLlz8h2A.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/_auth+/verify": { "id": "routes/_auth+/verify", "parentId": "root", "path": "verify", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/verify-Z-ahZxbT.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/honeypot-2dXBK_pE.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/forms-N1UyfrLg.js", "/assets/spacer-HzAknbkR.js", "/assets/status-button-90R1EB0H.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/_marketing+/about": { "id": "routes/_marketing+/about", "parentId": "root", "path": "about", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/about-UNeT1r0O.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js"], "css": [] }, "routes/_marketing+/index": { "id": "routes/_marketing+/index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/index-OtunpFn0.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/index-ZFFQbiMA.js", "/assets/misc-c4cT4DYz.js", "/assets/tooltip-mNaDE02G.js"], "css": [] }, "routes/_marketing+/privacy": { "id": "routes/_marketing+/privacy", "parentId": "root", "path": "privacy", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/privacy-UeqOZ1YG.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js"], "css": [] }, "routes/_marketing+/support": { "id": "routes/_marketing+/support", "parentId": "root", "path": "support", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/support-LtW_-Gav.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js"], "css": [] }, "routes/_marketing+/tailwind-preset": { "id": "routes/_marketing+/tailwind-preset", "parentId": "root", "path": "tailwind-preset", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/tailwind-preset-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/_marketing+/tos": { "id": "routes/_marketing+/tos", "parentId": "root", "path": "tos", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/tos-dErBPYyr.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js"], "css": [] }, "routes/_seo+/robots[.]txt": { "id": "routes/_seo+/robots[.]txt", "parentId": "root", "path": "robots.txt", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/robots_._txt-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/_seo+/sitemap[.]xml": { "id": "routes/_seo+/sitemap[.]xml", "parentId": "root", "path": "sitemap.xml", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/sitemap_._xml-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/admin+/cache": { "id": "routes/admin+/cache", "parentId": "root", "path": "admin/cache", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/cache-lMg-Chac.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/forms-N1UyfrLg.js", "/assets/spacer-HzAknbkR.js", "/assets/components-_HPsJqfq.js"], "css": [] }, "routes/admin+/cache_.lru.$cacheKey": { "id": "routes/admin+/cache_.lru.$cacheKey", "parentId": "root", "path": "admin/cache/lru/:cacheKey", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/cache_.lru._cacheKey-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/admin+/cache_.sqlite": { "id": "routes/admin+/cache_.sqlite", "parentId": "root", "path": "admin/cache/sqlite", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/cache_.sqlite-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/admin+/cache_.sqlite.$cacheKey": { "id": "routes/admin+/cache_.sqlite.$cacheKey", "parentId": "routes/admin+/cache_.sqlite", "path": ":cacheKey", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/cache_.sqlite._cacheKey-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/me": { "id": "routes/me", "parentId": "root", "path": "me", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/me-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/resources+/download-user-data": { "id": "routes/resources+/download-user-data", "parentId": "root", "path": "resources/download-user-data", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/download-user-data-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/resources+/healthcheck": { "id": "routes/resources+/healthcheck", "parentId": "root", "path": "resources/healthcheck", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/healthcheck-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/resources+/note-images.$imageId": { "id": "routes/resources+/note-images.$imageId", "parentId": "root", "path": "resources/note-images/:imageId", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/note-images._imageId-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/resources+/user-images.$imageId": { "id": "routes/resources+/user-images.$imageId", "parentId": "root", "path": "resources/user-images/:imageId", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/user-images._imageId-w40geAFS.js?client-route=1", "imports": [], "css": [] }, "routes/settings+/profile": { "id": "routes/settings+/profile", "parentId": "root", "path": "settings/profile", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile-GDVwOwb6.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/components-_HPsJqfq.js", "/assets/index-_I1O5d5t.js", "/assets/spacer-HzAknbkR.js", "/assets/icon-A96BYhEN.js", "/assets/user-8GWnie8l.js"], "css": [] }, "routes/settings+/profile.change-email": { "id": "routes/settings+/profile.change-email", "parentId": "routes/settings+/profile", "path": "change-email", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.change-email-c7i-OlZo.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/settings+/profile.connections": { "id": "routes/settings+/profile.connections", "parentId": "routes/settings+/profile", "path": "connections", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.connections-vOgcPiDw.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/status-button-90R1EB0H.js", "/assets/connections-eLlz8h2A.js", "/assets/components-_HPsJqfq.js"], "css": [] }, "routes/settings+/profile.index": { "id": "routes/settings+/profile.index", "parentId": "routes/settings+/profile", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.index-mH3WEw1Y.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/settings+/profile.password": { "id": "routes/settings+/profile.password", "parentId": "routes/settings+/profile", "path": "password", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.password-Jndf0DXi.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/settings+/profile.password_.create": { "id": "routes/settings+/profile.password_.create", "parentId": "routes/settings+/profile", "path": "password/create", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.password_.create-l99ilgAl.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/user-validation-jMhO3qPJ.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/settings+/profile.photo": { "id": "routes/settings+/profile.photo", "parentId": "routes/settings+/profile", "path": "photo", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.photo-Xmkz1bCX.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/settings+/profile.two-factor": { "id": "routes/settings+/profile.two-factor", "parentId": "routes/settings+/profile", "path": "two-factor", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.two-factor-jVuOR6uN.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/icon-A96BYhEN.js"], "css": [] }, "routes/settings+/profile.two-factor.disable": { "id": "routes/settings+/profile.two-factor.disable", "parentId": "routes/settings+/profile.two-factor", "path": "disable", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.two-factor.disable--uZq-b_U.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/status-button-90R1EB0H.js", "/assets/components-_HPsJqfq.js"], "css": [] }, "routes/settings+/profile.two-factor.index": { "id": "routes/settings+/profile.two-factor.index", "parentId": "routes/settings+/profile.two-factor", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.two-factor.index-k_hiN7Cj.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/status-button-90R1EB0H.js", "/assets/components-_HPsJqfq.js"], "css": [] }, "routes/settings+/profile.two-factor.verify": { "id": "routes/settings+/profile.two-factor.verify", "parentId": "routes/settings+/profile.two-factor", "path": "verify", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/profile.two-factor.verify-CuTul2iR.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/users+/$username": { "id": "routes/users+/$username", "parentId": "root", "path": "users/:username", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_username-5dLv0Eg4.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/components-_HPsJqfq.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/spacer-HzAknbkR.js", "/assets/button-P80Fawty.js", "/assets/icon-A96BYhEN.js", "/assets/user-8GWnie8l.js"], "css": [] }, "routes/users+/$username_+/notes": { "id": "routes/users+/$username_+/notes", "parentId": "root", "path": "users/:username/notes", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/notes-k8_8jeP3.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/components-_HPsJqfq.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/icon-A96BYhEN.js", "/assets/user-8GWnie8l.js"], "css": [] }, "routes/users+/$username_+/notes.$noteId": { "id": "routes/users+/$username_+/notes.$noteId", "parentId": "routes/users+/$username_+/notes", "path": ":noteId", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/notes._noteId-uHOfRpqX.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/components-_HPsJqfq.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/floating-toolbar-g51npo7X.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/user-8GWnie8l.js", "/assets/helpers-wg4fqsUl.js"], "css": [] }, "routes/users+/$username_+/notes.$noteId_.edit": { "id": "routes/users+/$username_+/notes.$noteId_.edit", "parentId": "routes/users+/$username_+/notes", "path": ":noteId/edit", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/notes._noteId_.edit-FuimTc-1.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/floating-toolbar-g51npo7X.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/notes.new-DZFDSJGb.js"], "css": [] }, "routes/users+/$username_+/notes.index": { "id": "routes/users+/$username_+/notes.index", "parentId": "routes/users+/$username_+/notes", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/notes.index-bEpvY4EP.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js"], "css": [] }, "routes/users+/$username_+/notes.new": { "id": "routes/users+/$username_+/notes.new", "parentId": "routes/users+/$username_+/notes", "path": "new", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/notes.new-DZFDSJGb.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-rVPpACB_.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/index-_I1O5d5t.js", "/assets/helpers-wg4fqsUl.js", "/assets/parse-k_gbqDJY.js", "/assets/floating-toolbar-g51npo7X.js", "/assets/forms-N1UyfrLg.js", "/assets/status-button-90R1EB0H.js", "/assets/components-_HPsJqfq.js", "/assets/constraint-zXtMoCF6.js"], "css": [] }, "routes/users+/index": { "id": "routes/users+/index", "parentId": "root", "path": "users/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/index-qAwVNRoP.js?client-route=1", "imports": ["/assets/jsx-runtime-Sh_Ykj9L.js", "/assets/index-HdLrP6Fo.js", "/assets/misc-c4cT4DYz.js", "/assets/hub-A-poxTxS.js", "/assets/index-rVPpACB_.js", "/assets/index-ZFFQbiMA.js", "/assets/button-P80Fawty.js", "/assets/label-Je57Ihep.js", "/assets/icon-A96BYhEN.js", "/assets/tooltip-mNaDE02G.js", "/assets/status-button-90R1EB0H.js", "/assets/error-boundary-s-7uL-dj.js", "/assets/forms-N1UyfrLg.js", "/assets/search-bar-hmvYgNX5.js", "/assets/components-_HPsJqfq.js"], "css": [] } }, "url": "/assets/manifest-2e8fc69c.js", "version": "2e8fc69c" };
